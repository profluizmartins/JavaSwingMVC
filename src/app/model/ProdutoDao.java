...
public class ProdutoDao {
    ...
    //Adicionar produtos
    public void adicionarProdutos(String nome, float preco) throws Execeptions {
    ...
    //Atualizar produtos
    public boolean atualizarProdutos(int id, String novoNome, float novoPreco) throws Execeptions {
        if (id <= 0) {
